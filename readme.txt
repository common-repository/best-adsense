=== Plugin Name ===
Contributors: Naeem
Donate link: http://www.moiz.co.uk
...
Automatically Insert Google Adsense code to your Blog. Here are some of the reasons why this plugin is outstanding:

* Different injection for single pages and pages with multiple Posts.
...
* For more info pleas visit : http://www.moiz.co.uk/best-adsense
* See plugin in works on :


== Installation ==

* Download
* Extract and copy Best Adsense folder to Plugins Directory (/wp-content/plugins) of your blog. (do not rename!) or you can install it from within your wordpress admin panel to do this click on add new under the plugin tab then search for Best Adsense you will see " Best Adsense " plugin by Naeem click the Install Now link this will automatically install the plugin
* Activate Plugin
